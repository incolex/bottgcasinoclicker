...
_MAX_DELTA_PER_MINUTE = 1_500_000  # 25к/сек × 60сек
...
DEFS_SERVER = [
    {"id": "c1", "type": "click", "val": 1,    "base": 18,     "mult": 1.32, "max": 10, "cat": "std"},
    {"id": "c2", "type": "click", "val": 3,    "base": 90,     "mult": 1.36, "max": 10, "cat": "std"},
    {"id": "c3", "type": "click", "val": 7,    "base": 480,    "mult": 1.38, "max": 10, "cat": "std"},
    {"id": "c4", "type": "click", "val": 9,    "base": 2200,   "mult": 1.38, "max": 10, "cat": "std"},
    {"id": "p1", "type": "ps",    "val": 0.005,"base": 38,     "mult": 1.32, "max": 10, "cat": "std"},
    {"id": "p2", "type": "ps",    "val": 0.012,"base": 150,    "mult": 1.35, "max": 10, "cat": "std"},
    {"id": "p3", "type": "ps",    "val": 0.025,"base": 600,    "mult": 1.37, "max": 10, "cat": "std"},
    {"id": "p4", "type": "ps",    "val": 0.04, "base": 3000,   "mult": 1.38, "max": 10, "cat": "std"},
    {"id": "p5", "type": "ps",    "val": 0.056,"base": 12000,  "mult": 1.40, "max": 10, "cat": "std"},
    {"id": "e1", "type": "click", "val": 20,   "base": 30000,  "mult": 1.8,  "max": 1,  "cat": "eli"},
    {"id": "e2", "type": "ps",    "val": 0.3,  "base": 75000,  "mult": 1.85, "max": 1,  "cat": "eli"},
    {"id": "e3", "type": "both",  "val": 1.15, "base": 220000, "mult": 2.5,  "max": 1,  "cat": "eli"},
    {"id": "e4", "type": "ps",    "val": 0.4,  "base": 420000, "mult": 2.5,  "max": 1,  "cat": "eli"},
    {"id": "leg1","type": "click","val": 50,   "base": 5,      "mult": 999,  "max": 1,  "cat": "leg"},
    {"id": "leg2","type": "both", "val": 1.1,  "base": 10,     "mult": 999,  "max": 1,  "cat": "leg"},
]
...
def save_game_state(req: SaveStateRequest):
    ...
    if client_delta > _MAX_DELTA_PER_SAVE:
        logger.warning(f"[ANTICHEAT] tg_id={req.tg_id} delta={client_delta} clamped to {_MAX_DELTA_PER_SAVE}")
    ...
    try:
        ...
        if client_delta > 0:
            ...
            cur.execute(
                """UPDATE users
                   SET game_balance = LEAST(GREATEST(game_balance + %s, 0), %s),
                       updated_at = %s
                   WHERE user_id = %s
                   RETURNING game_balance""",
                (client_delta, _MAX_BALANCE, int(time.time()), req.tg_id)
            )
            result = cur.fetchone()
            ...
            new_balance = min(new_balance, _MAX_BALANCE)
            cur.execute(
