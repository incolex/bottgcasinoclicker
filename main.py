...
def _ocp_main_kb():
    return InlineKeyboardMarkup([
        ...
        [InlineKeyboardButton("🔴 Забрать права OCP",     callback_data="ocp_removeadmin")],
        [InlineKeyboardButton("👥 Список администраторов",callback_data="ocp_adminlist")],
...
async def ocp_callback(update: Update, ctx: ContextTypes.DEFAULT_TYPE):
    ...
    if data == "ocp_find":
        ...
        try:
            ...
            cur.execute("UPDATE users SET game_balance=0, game_state=NULL, xp=0, level=1")
